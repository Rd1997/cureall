...
<h2 align="center"> Pharmacists's List</h2>
...
$query = mysqli_query($conn, " DELETE FROM phyre WHERE nameu='".$user."'");
$query = mysqli_query($conn, " DELETE FROM phy_login WHERE user='".$user."'");
}}
$conn = new mysqli('localhost', 'root', '123456') or die (mysqli_error()); // DB Connection
$db = mysqli_select_db($conn, 'cureall') or die("DB Error"); // Select DB from database
//Selecting Database
$sql = "Select nameu from phyre";
