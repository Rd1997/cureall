...
<h2 align="center"> Pharmacist's Registration </h2>
...
<label>Username:</label><input type="var" name="user" required>
...
$user = $_POST['user'];
 ...
 $query = mysqli_query($conn, "SELECT * FROM phyre WHERE user='".$user."'");
 $numrows = mysqli_num_rows($query);
 if($numrows == 0)
 
 {
 //Insert to Mysqli Query
 $sql = "INSERT INTO phy_login(user,pass) VALUES('$user','$pass')";
 $resul = mysqli_query($conn, $sql);

 
 //Insert to Mysqli Query
 $sql = "INSERT INTO phyre(nameu,mailid,mob,user,pass,Qualification,aid) VALUES('$nameu','$mailid','$mob','$user','$pass','$Qualification','$aid')";
